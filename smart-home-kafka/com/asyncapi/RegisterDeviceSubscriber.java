...
public class RegisterDeviceSubscriber  extends PubSubBase{
  ...
  public RegisterDeviceSubscriber() {
      ...
      this.createConnection("registerDevice", id);

      consumer = ch.createConsumer("registerDevice");
    ...
    while (continueProcessing) {
        try {
            ...
            for (ConsumerRecord<String, String> record : records) {
                ...
                DeviceRegistrationInfo receivedObject = new ObjectMapper().readValue(record.value(), DeviceRegistrationInfo.class);
